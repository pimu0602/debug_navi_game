...
const WorkPlan = (() => {
  ...
  const questions=[['prep','準備するものは？',[['tester','テスターだけ'],['both','テスターとペンを準備し、図面を確認']]],['safety','抵抗測定の前に何をする？',[['lever','レバーのOFF表示だけ確認'],['measure','レバーOFFと、相間3組の無電圧を実測']]],['cp','導通確認に使うCPは？',[['all','すべてON'],['off','すべてOFFのまま'],['needed','図面に沿ってCP1・CP2だけON']]]];
